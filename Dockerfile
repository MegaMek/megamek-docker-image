...
ENV TRIMMED_MM_VERSION=${MM_VERSION:1}
ARG SENTRY_ENABLED
...
RUN apt-get update && \
  ...
  apt-get clean
ADD  "https://github.com/MegaMek/megamek/releases/download/${MM_VERSION}/megamek-${TRIMMED_MM_VERSION}.tar.gz" /tmp/megamek.tar.gz
